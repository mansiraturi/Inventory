...
public class modelTable {
    ...
    String p_sourceOfPurchase, int p_landingPurchaseValue, int p_sellingValue, String p_stockLocation, String p_techDetails, String p_setOf, String p_prefix, String p_comment) {
